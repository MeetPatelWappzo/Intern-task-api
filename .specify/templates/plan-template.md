...
- [ ] **Gate 2: RESTful API Design**
  - All endpoint paths MUST use plural resource nouns. HTTP methods and status codes MUST follow standard REST conventions.
- [ ] **Gate 3: JSDoc & Swagger Documentation**
  - All controller handlers and endpoints MUST have JSDoc comments matching OpenAPI specs for Swagger generation.
- [ ] **Gate 4: Media Upload Limits**
  - Image upload paths MUST enforce a strict 2MB limit using Multer before processing downstream.
- [ ] **Gate 5: Code Simplicity**
